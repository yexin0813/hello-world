...
static const struct ke_msg_handler display_default_state[] =
{
    #if DISPLAY_PERIODIC
...
/// Specifies the message handlers that are common to all states.
static const struct ke_state_handler display_default_handler = KE_STATE_HANDLER(display_default_state);
...
const struct ke_task_desc TASK_DESC_DISPLAY = {NULL, &display_default_handler, display_state, DISPLAY_STATE_MAX, DISPLAY_IDX_MAX};
