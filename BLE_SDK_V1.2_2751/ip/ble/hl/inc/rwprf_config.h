...
/// Apollo BLE OTA Server Role
#if defined(CFG_PRF_BXOTAS)
#define BLE_BXOTA_SERVER    1
#else
#define BLE_BXOTA_SERVER    0
#endif // defined(CFG_PRF_BXOTAS)

/// Apollo BLE OTA Client Role
#if defined(CFG_PRF_BXOTAC)
#define BLE_BXOTA_CLINET    1
#else
#define BLE_BXOTA_CLIENT    0
#endif // defined(CFG_PRF_BXOTAC)

/// Apple Notification Center Client Role
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_UDS_CLIENT || BLE_BCS_CLIENT || BLE_WPT_CLIENT || BLE_PLX_CLIENT || BLE_BXOTA_CLIENT || BLE_ANC_CLIENT)
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
        ...
        || BLE_UDS_SERVER || BLE_BCS_SERVER || BLE_WPT_SERVER || BLE_PLX_SERVER || BLE_BXOTA_SERVER)
