...
int l2cc_process_op(uint8_t conidx, uint8_t op_type, void* op_msg, enum l2cc_operation* supp_ops)
{
    ...
    {
        l2cc_send_error_evt(conidx, operation, ke_msg_src_id_get(op_msg), status, L2C_CID_LE_SIGNALING);
    }
 ...
 ****************************************************************************************
 */
static int l2cc_pdu_send_cmd_handler(ke_msg_id_t const msgid, struct l2cc_pdu_send_cmd *param,
 ...
 ****************************************************************************************
 */
static int l2cc_lecb_sdu_send_cmd_handler(ke_msg_id_t const msgid, struct l2cc_lecb_sdu_send_cmd *param,
                                     ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // Current process state
    uint8_t state     = ke_state_get(dest_id);
 ...
 ****************************************************************************************
 */
static int l2cc_dbg_pdu_send_cmd_handler(ke_msg_id_t const msgid, struct l2cc_dbg_pdu_send_cmd *param,
                                     ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // Current process state
    uint8_t state     = ke_state_get(dest_id);
    ...
    if(status != GAP_ERR_NO_ERROR)
    {
        l2cc_send_error_evt(conidx, param->operation, src_id, status, co_read16p(param->pdu.data));
    }
    else
    {
        // retrieve message
 ...
 ****************************************************************************************
 */
static int hci_nb_cmp_pkts_evt_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int hci_acl_data_rx_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int l2cc_lecb_connect_cmd_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int l2cc_lecb_connect_cfm_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int l2cc_lecb_disconnect_cmd_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int l2cc_signaling_trans_to_ind_handler(ke_msg_id_t const msgid, void const *param,
                                             ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // Current process state
    uint8_t state = ke_state_get(dest_id);
 ...
 ****************************************************************************************
 */
static int l2cc_lecb_add_cmd_handler(ke_msg_id_t const msgid,
...
const struct ke_msg_handler l2cc_default_state[] =
{
    ...
    { HCI_ACL_DATA_RX,                  (ke_msg_func_t) hci_acl_data_rx_handler },

    { L2CC_PDU_RECV_IND,                (ke_msg_func_t) l2cc_pdu_recv_ind_handler },
};

/// Specifies the message handlers that are common to all states.
const struct ke_state_handler l2cc_default_handler = KE_STATE_HANDLER(l2cc_default_state);
