 ...
 ****************************************************************************************
 */
static int gattc_exc_mtu_cmd_handler(ke_msg_id_t const msgid, struct gattc_exc_mtu_cmd *param,
 ...
 ****************************************************************************************
 */
static int gattc_disc_cmd_handler(ke_msg_id_t const msgid, struct gattc_disc_cmd *param,
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gattc_read_cmd_handler(ke_msg_id_t const msgid, struct gattc_read_cmd *param,
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gattc_write_cmd_handler(ke_msg_id_t const msgid, struct gattc_write_cmd *param,
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gattc_event_cfm_handler(ke_msg_id_t const msgid, struct gattc_event_cfm *param,
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // Current connection index
    uint8_t conidx = KE_IDX_GET(dest_id);
 ...
 ****************************************************************************************
 */
static int gattc_execute_write_cmd_handler(ke_msg_id_t const msgid, struct gattc_execute_write_cmd *param,
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gattc_reg_to_peer_evt_cmd_handler(ke_msg_id_t const msgid,
                                        ...
                                        ke_task_id_t const src_id)
{
    ...
    if(msg_status == KE_MSG_NO_FREE)
    {
        ...
        if(param->operation == GATTC_UNREGISTER)
        {
            ...
            {
                //unregister event
                co_list_extract(&(gattc_env[conidx]->client.reg_evt), &(reg_evt->hdr), 0);
                ke_free(reg_evt);
            }
            else
            {
 ...
 ****************************************************************************************
 */
static int gattc_sdp_svc_disc_cmd_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int gattc_cmp_evt_handler(ke_msg_id_t const msgid, struct gattc_cmp_evt *evt,
                                 ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t conidx = KE_IDX_GET(dest_id);
 ...
 ****************************************************************************************
 */
static int gattc_disc_svc_ind_handler(ke_msg_id_t const msgid, struct gattc_disc_svc_ind *ind,
                                      ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t conidx = KE_IDX_GET(dest_id);
 ...
 ****************************************************************************************
 */
static int gattc_disc_svc_incl_ind_handler(ke_msg_id_t const msgid, struct gattc_disc_svc_incl_ind *ind,
                                           ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t conidx = KE_IDX_GET(dest_id);
    uint8_t opcode = gattc_get_operation(conidx, GATTC_OP_SDP);
 ...
 ****************************************************************************************
 */
static int gattc_disc_char_ind_handler(ke_msg_id_t const msgid, struct gattc_disc_char_ind *ind,
                                       ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t conidx = KE_IDX_GET(dest_id);
    uint8_t opcode = gattc_get_operation(conidx, GATTC_OP_SDP);
 ...
 ****************************************************************************************
 */
static int gattc_disc_char_desc_ind_handler(ke_msg_id_t const msgid, struct gattc_disc_char_desc_ind *ind,
                                            ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t conidx = KE_IDX_GET(dest_id);
    uint8_t opcode = gattc_get_operation(conidx, GATTC_OP_SDP);
 ...
 ****************************************************************************************
 */
static int gattc_send_evt_cmd_handler(ke_msg_id_t const msgid, struct gattc_send_evt_cmd *param,
                                      ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gattc_send_svc_changed_cmd_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int gattc_att_info_cfm_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int gattc_timeout_handler(ke_msg_id_t const msgid, void const *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    if(state != GATTC_FREE)
    {
        ...
        {
            ke_msg_send_basic(GATTC_TRANSACTION_TO_ERROR_IND, APP_MAIN_TASK, dest_id);
        }
 ...
 ****************************************************************************************
 */
static int gapc_sign_ind_handler(ke_msg_id_t const msgid, struct gapc_sign_ind *param,
                                 ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t state = ke_state_get(dest_id);
    uint8_t conidx = KE_IDX_GET(dest_id);
 ...
 ****************************************************************************************
 */
static int gapc_cmp_evt_handler(ke_msg_id_t const msgid, struct gapc_cmp_evt *evt,
                                 ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t state = ke_state_get(dest_id);
    uint8_t conidx = KE_IDX_GET(dest_id);
 ...
 ****************************************************************************************
 */
static int l2cc_pdu_recv_ind_handler(ke_msg_id_t const msgid, struct l2cc_pdu_recv_ind *param,
                             ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t state = ke_state_get(dest_id);
    int msg_status = KE_MSG_CONSUMED;
 ...
 ****************************************************************************************
 */
static int gattc_default_msg_handler(ke_msg_id_t const msgid, void const *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t state = ke_state_get(dest_id);
    if(state != GATTC_FREE)
    {
        ...
        gattc_send_error_evt(KE_IDX_GET(dest_id), *((uint8_t*)param), *(((uint8_t*)param)+1), src_id, GATT_ERR_ATTRIBUTE_CLIENT_MISSING);
        #elif (!BLE_ATTS)
        gattc_send_error_evt(KE_IDX_GET(dest_id), *((uint8_t*)param), *(((uint8_t*)param)+1), src_id, GATT_ERR_ATTRIBUTE_SERVER_MISSING);
        #endif // (BLE_ATTC)
    }
 ...
 ****************************************************************************************
 */
static int gattc_read_req_ind_handler(ke_msg_id_t const msgid, struct gattc_write_req_ind *param,
                                       ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // Connection Index
    uint8_t conidx = KE_IDX_GET(src_id);
...
const struct ke_msg_handler gattc_default_state[] =
{
...
const struct ke_state_handler gattc_default_handler = KE_STATE_HANDLER(gattc_default_state);
