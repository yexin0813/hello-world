 ...
 ****************************************************************************************
 */
static int gapm_reset_cmd_handler(ke_msg_id_t const msgid, struct gapm_reset_cmd *param,
 ...
 ****************************************************************************************
 */
static int gapm_cancel_cmd_handler(ke_msg_id_t const msgid, struct gapm_cancel_cmd const *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    uint8_t status = GAP_ERR_NO_ERROR;
 ...
 ****************************************************************************************
 */
static int gapm_set_dev_config_cmd_handler(ke_msg_id_t const msgid, struct gapm_set_dev_config_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
 ...
 ****************************************************************************************
 */
static int gapm_set_channel_map_cmd_handler(ke_msg_id_t const msgid, struct gapm_set_channel_map_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gapm_get_dev_info_cmd_handler(ke_msg_id_t const msgid, struct gapm_get_dev_info_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gapm_white_list_mgt_cmd_handler(ke_msg_id_t const msgid,
        ...
        switch(param->operation)
        {
            ...
            case GAPM_ADD_DEV_IN_WLIST:
            {
                ...
                if(param->nb > 0)
                {
                    ...
                    struct hci_le_add_dev_to_wlst_cmd *add_dev = KE_MSG_ALLOC(HCI_COMMAND, 0, HCI_LE_ADD_DEV_TO_WLST_CMD_OPCODE, hci_le_add_dev_to_wlst_cmd);
            ...
            case GAPM_RMV_DEV_FRM_WLIST:
            {
                ...
                if(param->nb > 0)
                {
                    ...
                    struct hci_le_rmv_dev_from_wlst_cmd *rem_dev = KE_MSG_ALLOC(HCI_COMMAND, 0, HCI_LE_RMV_DEV_FROM_WLST_CMD_OPCODE, hci_le_rmv_dev_from_wlst_cmd);
 ...
 ****************************************************************************************
 */
static int gapm_resolv_addr_cmd_handler(ke_msg_id_t const msgid, struct gapm_resolv_addr_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gapm_start_advertise_cmd_handler(ke_msg_id_t const msgid, struct gapm_start_advertise_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gapm_update_advertise_data_cmd_handler(ke_msg_id_t const msgid, struct gapm_update_advertise_data_cmd *param,
                                                  ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gapm_lim_disc_to_ind_handler(ke_msg_id_t const msgid, void const *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // Current process state
 ...
 ****************************************************************************************
 */
static int gapm_start_scan_cmd_handler(ke_msg_id_t const msgid, struct gapm_start_scan_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gapm_scan_to_ind_handler(ke_msg_id_t const msgid, void const *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // Current process state
    uint8_t state = ke_state_get(dest_id);
 ...
 ****************************************************************************************
 */
static int gapm_start_connection_cmd_handler(ke_msg_id_t const msgid, struct gapm_start_connection_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
 ...
 ****************************************************************************************
 */
static int gapm_connection_cfm_handler(ke_msg_id_t const msgid, struct gapm_connection_cfm const *cfm,
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // Current process state
    uint8_t state = ke_state_get(dest_id);
        ...
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
            ...
            && (gapm_get_operation(GAPM_OP_AIR) == GAPM_CONNECTION_NAME_REQUEST))
    {
        ...
        struct gapm_peer_name_ind * name_ind =
                KE_MSG_ALLOC_DYN(GAPM_PEER_NAME_IND, gapm_get_requester(GAPM_OP_AIR),
 ...
 ****************************************************************************************
 */
static int gapm_addr_renew_to_ind_handler(ke_msg_id_t const msgid, void const *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // Current process state
    uint8_t state = ke_state_get(dest_id);
 ...
 ****************************************************************************************
 */
static int gapm_profile_task_add_cmd_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int gapm_default_msg_handler(ke_msg_id_t const msgid, void *event,
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    return (KE_MSG_CONSUMED);
}
 ...
 ****************************************************************************************
 */
static int gapm_gen_rand_addr_cmd_handler(ke_msg_id_t const msgid, struct gapm_gen_rand_addr_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gapm_use_enc_block_cmd_handler(ke_msg_id_t const msgid,
...
static int gapm_gen_dh_key_cmd_handler(ke_msg_id_t const msgid,
 ...
 ****************************************************************************************
 */
static int gapm_unknown_task_msg_handler(ke_msg_id_t const msgid,  void * param,
                                          ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
 ...
 ****************************************************************************************
 */
static int gapm_ral_mgt_cmd_handler(ke_msg_id_t const msgid,
    ...
    if(msg_status == KE_MSG_NO_FREE)
    {
        switch(param->operation)
        {
            ...
            case GAPM_GET_RAL_PEER_ADDR:
            {
                ...
                {
                    /* add specific address in the list */
                    struct hci_le_rd_loc_rslv_addr_cmd *rd_addr = KE_MSG_ALLOC(
            ...
            case GAPM_ADD_DEV_IN_RAL:
            {
                ...
                {
                    /* add specific address in the list */
                    struct hci_le_add_dev_to_rslv_list_cmd *add_dev = KE_MSG_ALLOC(
            ...
            case GAPM_RMV_DEV_FRM_RAL:
            {
                ...
                {
                    /* remove specific address in the list */
                    struct hci_le_rmv_dev_from_rslv_list_cmd *rem_dev = KE_MSG_ALLOC(
 ...
 ****************************************************************************************
 */
static int gapm_set_irk_cmd_handler(ke_msg_id_t const msgid, struct gapm_set_irk_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gapm_lepsm_register_cmd_handler(ke_msg_id_t const msgid, struct gapm_lepsm_register_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
 ...
 ****************************************************************************************
 */
static int gapm_lepsm_unregister_cmd_handler(ke_msg_id_t const msgid, struct gapm_lepsm_unregister_cmd *param,
                   ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // list of handler supported operations
    ...
    if(msg_status == KE_MSG_NO_FREE)
    {
        ...
        else if(info->nb_est_lk == 0)
        {
            ...
            co_list_extract(&(gapm_env.reg_le_psm), &(info->hdr), 0);
            ke_free(info);
        }
        else
        {
...
extern int gapm_hci_handler(ke_msg_id_t const msgid, void const* event, ke_task_id_t dest_id, ke_task_id_t src_id);
...
const struct ke_msg_handler gapm_default_state[] =
{
    ...
    { GAPM_CANCEL_CMD,                        (ke_msg_func_t) gapm_cancel_cmd_handler },
    ...
    { GAPM_WHITE_LIST_MGT_CMD,                (ke_msg_func_t) gapm_white_list_mgt_cmd_handler },
    ...
    #if (BLE_PERIPHERAL || BLE_BROADCASTER)
    { GAPM_START_ADVERTISE_CMD,               (ke_msg_func_t) gapm_start_advertise_cmd_handler },
    { GAPM_UPDATE_ADVERTISE_DATA_CMD,         (ke_msg_func_t) gapm_update_advertise_data_cmd_handler },
    { GAPM_LIM_DISC_TO_IND,                   (ke_msg_func_t) gapm_lim_disc_to_ind_handler },
    #endif // (BLE_PERIPHERAL || BLE_BROADCASTER)

    /* Scan procedure */
    #if (BLE_CENTRAL || BLE_OBSERVER)
    { GAPM_START_SCAN_CMD,                    (ke_msg_func_t) gapm_start_scan_cmd_handler },
    { GAPM_SCAN_TO_IND,                       (ke_msg_func_t) gapm_scan_to_ind_handler },
    #endif // (BLE_CENTRAL || BLE_OBSERVER)

    /* Connection procedure */
    #if (BLE_CENTRAL)
    { GAPM_START_CONNECTION_CMD,              (ke_msg_func_t) gapm_start_connection_cmd_handler },
    { GAPC_CMP_EVT,                           (ke_msg_func_t) gapc_cmp_evt_handler },
    { GAPC_PEER_ATT_INFO_IND,                 (ke_msg_func_t) gapc_peer_att_info_ind_handler },
    { GAPM_CONNECTION_CFM,                    (ke_msg_func_t) gapm_connection_cfm_handler },
    #endif // (BLE_CENTRAL)
    #if (BLE_CENTRAL || BLE_PERIPHERAL)
    ...
    { GAPM_RAL_MGT_CMD,                       (ke_msg_func_t) gapm_ral_mgt_cmd_handler },
...
const struct ke_state_handler gapm_default_handler = KE_STATE_HANDLER(gapm_default_state);
