#ifndef DW_APB_SSI_TYPEDEF_H_
#define DW_APB_SSI_TYPEDEF_H_
typedef enum{
...
typedef enum 
{
	Transmit_FIFO_Empty_interrupt = 1,
	Transmit_FIFO_Overflow_interrupt = 2,
	Receive_FIFO_Underflow_interrupt = 4,
	Receive_FIFO_Overflow_interrupt = 8,
	Receive_FIFO_Full_interrupt		= 16,
	Multi_Master_Connection_interrupt = 32
}SPI_ISR;
#endif
