//////////////////////////////////////////////////////////////////////////////
//  Copyright (C) by Apollo.
//  This module is a confidential and proprietary property of Apollo
...
typedef struct
{
    volatile           T_SYSC_AWO_REG_MISC_1                     reg_misc_1; /*  0x0,    RW, 0x00E00081,             CLK INTRP Register*/
    volatile      T_SYSC_AWO_REG_AWO_CLKG_EN                reg_awo_clkg_en; /*  0x4,    RW, 0x0000FFFF,          AWO clkg set Register*/
    volatile         T_SYSC_AWO_REG_IO_STATE                   reg_io_state; /*  0x8,    RW, 0x00000000,      IO state control Register*/
    volatile         T_SYSC_AWO_REG_PD_ONOFF                   reg_pd_onoff; /*  0xc,    RW, 0x00000000,         SW control PD Register*/
    volatile      T_SYSC_AWO_REG_SRAM_LOWVDD                reg_sram_lowvdd; /* 0x10,    RW, 0x7F07007F,        SRAM retention Register*/
    volatile        T_SYSC_AWO_REG_PMU_TIMER                  reg_pmu_timer; /* 0x14,    RW, 0x08A51A10,             PMU timer Register*/
    volatile  T_SYSC_AWO_REG_WAKEUP_SRC_MASK            reg_wakeup_src_mask; /* 0x18,    RW, 0x00000680,           wakeup mask Register*/
    volatile      T_SYSC_AWO_REG_CLK_LDO_SEL                reg_clk_ldo_sel; /* 0x1c,    RW, 0x00121C00,       LDO CLK control Register*/
    volatile         T_SYSC_AWO_REG_PD_STATE                   reg_pd_state; /* 0x20,    RO, 0x00000F7F,              PD state Register*/
    volatile      T_SYSC_AWO_EXT_INRP_CONFIG                ext_inrp_config; /* 0x24,    RW, 0x0002AA00,                No description.*/
    volatile       T_SYSC_AWO_EXT_INRP_VALUE                 ext_inrp_value; /* 0x28,    RO, 0x00000000,                No description.*/
    volatile         T_SYSC_AWO_EXT_INRP_CLR                   ext_inrp_clr; /* 0x2c,    RW, 0x00000000,                No description.*/
    volatile     T_SYSC_AWO_BLELP_INRP_VALUE               blelp_inrp_value; /* 0x30,    RO, 0x00000000,                No description.*/
    volatile       T_SYSC_AWO_BLELP_INRP_CLR                 blelp_inrp_clr; /* 0x34,    RW, 0x00000000,                No description.*/
    volatile  T_SYSC_AWO_CLKGEN_AWO_SIGNAL_1            clkgen_awo_signal_1; /* 0x38,    RW, 0x00000000,                No description.*/
    volatile  T_SYSC_AWO_CLKGEN_AWO_SIGNAL_2            clkgen_awo_signal_2; /* 0x3c,    RW, 0x00000002,                No description.*/
    volatile     T_SYSC_AWO_AWO_RESET_SIGNAL               awo_reset_signal; /* 0x40,    RW, 0x000003FF,                No description.*/
    volatile        T_SYSC_AWO_RAM_PARAMETER                  ram_parameter; /* 0x44,    RW, 0x12C012C0,                No description.*/
    volatile            T_SYSC_AWO_VDD_VALUE                      vdd_value; /* 0x48,    RW, 0x00000003,                No description.*/
    volatile             T_SYSC_AWO_GPIO_DS0                       gpio_ds0; /* 0x4c,    RW, 0x3FFFFFFF,                No description.*/
    volatile             T_SYSC_AWO_GPIO_DS1                       gpio_ds1; /* 0x50,    RW, 0x3FFFFFFF,                No description.*/
    volatile              T_SYSC_AWO_GPIO_IE                        gpio_ie; /* 0x54,    RW, 0x3FFFFFFF,                No description.*/
    volatile              T_SYSC_AWO_GPIO_IS                        gpio_is; /* 0x58,    RW, 0x00000000,                No description.*/
    volatile              T_SYSC_AWO_GPIO_PE                        gpio_pe; /* 0x5c,    RW, 0x00000000,                No description.*/
    volatile              T_SYSC_AWO_GPIO_PS                        gpio_ps; /* 0x60,    RW, 0x00000000,                No description.*/
    volatile          T_SYSC_AWO_TOUCH_CFG_1                    touch_cfg_1; /* 0x64,    RW, 0x00030000,                No description.*/
    volatile          T_SYSC_AWO_TOUCH_CFG_2                    touch_cfg_2; /* 0x68,    RW, 0x00000000,                No description.*/
    volatile          T_SYSC_AWO_TOUCH_CFG_3                    touch_cfg_3; /* 0x6c,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_0                       rf_reg_0; /* 0x70,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_1                       rf_reg_1; /* 0x74,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_2                       rf_reg_2; /* 0x78,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_3                       rf_reg_3; /* 0x7c,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_4                       rf_reg_4; /* 0x80,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_5                       rf_reg_5; /* 0x84,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_6                       rf_reg_6; /* 0x88,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_7                       rf_reg_7; /* 0x8c,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_8                       rf_reg_8; /* 0x90,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_9                       rf_reg_9; /* 0x94,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_A                       rf_reg_a; /* 0x98,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_B                       rf_reg_b; /* 0x9c,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_C                       rf_reg_c; /* 0xa0,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_D                       rf_reg_d; /* 0xa4,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_E                       rf_reg_e; /* 0xa8,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_RF_REG_F                       rf_reg_f; /* 0xac,    RW, 0x00000000,                No description.*/
    volatile            T_SYSC_AWO_RF_REG_RD                      rf_reg_rd; /* 0xb0,    RO, 0x22446689,                No description.*/
    volatile                        uint32_t                  reserved_1[3];
    volatile             T_SYSC_AWO_PWR_PWM0                       pwr_pwm0; /* 0xc0,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_PWR_PWM1                       pwr_pwm1; /* 0xc4,    RW, 0x00000000,                No description.*/
    volatile             T_SYSC_AWO_PWR_PWM2                       pwr_pwm2; /* 0xc8,    RW, 0x00000000,                No description.*/
    volatile         T_SYSC_AWO_PWR_PWM_CTRL                   pwr_pwm_ctrl; /* 0xcc,    RW, 0x00000111,                No description.*/
    volatile            T_SYSC_AWO_BOOT_MODE                      boot_mode; /* 0xd0,    RO, 0x00000000,                No description.*/
} T_HWP_SYSC_AWO_T;
...
{
    T_SYSC_AWO_REG_MISC_1 localVal = hwp_sysc_awo->reg_misc_1;
...
{
    T_SYSC_AWO_REG_IO_STATE localVal = hwp_sysc_awo->reg_io_state;
...
{
    T_SYSC_AWO_REG_PD_ONOFF localVal = hwp_sysc_awo->reg_pd_onoff;
...
{
    T_SYSC_AWO_REG_SRAM_LOWVDD localVal = hwp_sysc_awo->reg_sram_lowvdd;
...
{
    T_SYSC_AWO_REG_PMU_TIMER localVal = hwp_sysc_awo->reg_pmu_timer;
...
{
    T_SYSC_AWO_REG_WAKEUP_SRC_MASK localVal = hwp_sysc_awo->reg_wakeup_src_mask;
...
{
    T_SYSC_AWO_REG_CLK_LDO_SEL localVal = hwp_sysc_awo->reg_clk_ldo_sel;
...
{
    T_SYSC_AWO_REG_PD_STATE localVal = hwp_sysc_awo->reg_pd_state;
...
{
    T_SYSC_AWO_EXT_INRP_CONFIG localVal = hwp_sysc_awo->ext_inrp_config;
...
{
    T_SYSC_AWO_EXT_INRP_VALUE localVal = hwp_sysc_awo->ext_inrp_value;
...
{
    T_SYSC_AWO_BLELP_INRP_VALUE localVal = hwp_sysc_awo->blelp_inrp_value;
...
{
    T_SYSC_AWO_CLKGEN_AWO_SIGNAL_2 localVal = hwp_sysc_awo->clkgen_awo_signal_2;
...
{
    T_SYSC_AWO_RAM_PARAMETER localVal = hwp_sysc_awo->ram_parameter;
...
{
    T_SYSC_AWO_VDD_VALUE localVal = hwp_sysc_awo->vdd_value;
...
{
    T_SYSC_AWO_TOUCH_CFG_1 localVal = hwp_sysc_awo->touch_cfg_1;
...
{
    T_SYSC_AWO_TOUCH_CFG_2 localVal = hwp_sysc_awo->touch_cfg_2;
...
{
    T_SYSC_AWO_TOUCH_CFG_3 localVal = hwp_sysc_awo->touch_cfg_3;
...
{
    T_SYSC_AWO_PWR_PWM0 localVal = hwp_sysc_awo->pwr_pwm0;
...
{
    T_SYSC_AWO_PWR_PWM1 localVal = hwp_sysc_awo->pwr_pwm1;
...
{
    T_SYSC_AWO_PWR_PWM2 localVal = hwp_sysc_awo->pwr_pwm2;
...
{
    T_SYSC_AWO_PWR_PWM_CTRL localVal = hwp_sysc_awo->pwr_pwm_ctrl;
