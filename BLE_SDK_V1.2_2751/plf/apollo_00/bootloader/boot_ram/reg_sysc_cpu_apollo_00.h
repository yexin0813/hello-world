...
typedef struct
{
    ...
    volatile           T_SYSC_CPU_FUNC_IO_EN                     func_io_en; /* 0x24,    RW, 0x00000000,                No description.*/
    volatile                        uint32_t                  reserved_4[2];
    volatile         T_SYSC_CPU_FUNC_IO_SEL0                   func_io_sel0; /* 0x30,    RW, 0x00000000,                No description.*/
    volatile         T_SYSC_CPU_FUNC_IO_SEL1                   func_io_sel1; /* 0x34,    RW, 0x00000000,                No description.*/
    volatile         T_SYSC_CPU_FUNC_IO_SEL2                   func_io_sel2; /* 0x38,    RW, 0x00000000,                No description.*/
...
{
    T_SYSC_CPU_SRST localVal = hwp_sysc_cpu->srst;
