...
typedef struct
{
    volatile              T_SYSC_PER_CLK_SEL                        clk_sel; /*  0x0,    RW, 0x00000000,                No description.*/
    volatile       T_SYSC_PER_CLK_DIV_PARAM0                 clk_div_param0; /*  0x4,    RW, 0x00000000,                No description.*/
    volatile       T_SYSC_PER_CLK_DIV_PARAM1                 clk_div_param1; /*  0x8,    RW, 0x00000000,                No description.*/
    volatile       T_SYSC_PER_CLK_DIV_PARAM2                 clk_div_param2; /*  0xc,    RW, 0x00000000,                No description.*/
    volatile                T_SYSC_PER_CLKG0                          clkg0; /* 0x10,    RW, 0x0FFFFFFF,                No description.*/
    volatile                T_SYSC_PER_CLKG1                          clkg1; /* 0x14,    RW, 0x00003FFF,                No description.*/
    volatile                 T_SYSC_PER_SRST                           srst; /* 0x18,    RW, 0x0003FFFF,                No description.*/
    volatile           T_SYSC_PER_UART_ISSIR                     uart_issir; /* 0x1c,    RW, 0x00000000,                No description.*/
} T_HWP_SYSC_PER_T;
